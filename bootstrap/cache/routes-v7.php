...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::TLClRM3pECZV5qDb',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'custom.facebook.callback',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/reset\\-password/([^/]++)/([^/]++)(*:41)|/stories/(?|([^/]++)(?|(*:71)|/edit(*:83)|(*:90))|search(*:104))|/category/([^/]++)(?|(*:134)|/edit(*:147)|(*:155))|/user/([^/]++)(?|(*:181)|/edit(*:194)|(*:202)))/?$}sDu',
    ),
    3 => 
    array (
      41 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\RegisterController@showRegisterForm',
        'controller' => 'App\\Http\\Controllers\\RegisterController@showRegisterForm',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\StoryController@search',
        'controller' => 'App\\Http\\Controllers\\StoryController@search',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
