        ...
        <div class="login-form">
            <form method="post" action="<?php echo e(route('login.post')); ?>" class="bg-light">
              <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(URL::to('/googleLogin')); ?>" class="btn btn-google btn-user btn-block " style="background: #e74c3c; color: #fff;"><i class="fa-brands fa-google" style="color: #fafafa;"></i>  Google</a>
